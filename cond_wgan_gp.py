...
result_f = open(
    f"{non_iid_str}_{opt.remove_labels_num}_{opt.filter_ratio}_cond_wgan_gp_result.csv",
    "w",
)
...
torch.save(
    ...
    f"generator/{non_iid_str}_{opt.remove_labels_num}_{opt.filter_ratio}_cond_wgan_gp",
)
